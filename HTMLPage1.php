...
<body>
    ...
    <div class="banner">
        <div class="content active">
            ...
            <p>
                Elevate your entrepreneurship with our all-in-one <br />
                e-commerce platform for student businesses
    ...
    <footer>
        <div class="footer-content">
            ...
            <div class="footer-ul-container">
                <ul class="category">
                    ...
                    <li><a href="clothes.html" class="footer-link">clothes</a></li>
                    <li><a href="accessori.css" class="footer-link">accessories</a></li>
                    <li><a href="#" class="footer-link"title="Coming Soon">footwear</a></li>
                </ul>
                <ul class="category">
                    <li class="category-title"> Electronics & Gadgets</li>
                    <li><a href="#" class="footer-link"title="Coming Soon">computers</a></li>
                    <li><a href="#" class="footer-link"title="Coming Soon">tablets</a></li>
                    <li><a href="#" class="footer-link"title="Coming Soon">smartphones</a></li>
                    <li><a href="#" class="footer-link"title="Coming Soon"> other smart devices</a></li>
                </ul>
                <ul class="category">
                    <li class="category-title"> Food</li>
                    <li><a href="#" class="footer-link"title="Coming Soon">Fast food</a></li>
                    <li><a href="#" class="footer-link"title="Coming Soon">Drinks</a></li>
                    <li><a href="#" class="footer-link"title="Coming Soon">Sweets</a></li>
                    <li><a href="#" class="footer-link"title="Coming Soon"> Snacks</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="footer-social-container">
            ...
            <div>
                <a href="#" class="social-link"title="Coming Soon">instagram</a>
                <a href="#" class="social-link"title="Coming Soon">facebook</a>
                <a href="#" class="social-link"title="Coming Soon">twitter</a>
            </div>
        </div>
